...
@Component
public class PlacementCareStrategy implements PlantBioSectionStrategy {

    @Override
    public PlantBioSectionKey key() {
        return PlantBioSectionKey.PLACEMENT_CARE;
    }

    @Override
    public String promptKey() {
        return "plant_placement_care_v1";
    }
    ...
    public Map<String, Object> schema() {
        return BioSectionSchemas.placementCare();
    }
}
