...
@Component
public class PruningCareStrategy implements PlantBioSectionStrategy {

    @Override
    public PlantBioSectionKey key() {
        return PlantBioSectionKey.PRUNING_CARE;
    }

    @Override
    public String promptKey() {
        return "plant_pruning_care_v1";
    }
    ...
    public Map<String, Object> schema() {
        return BioSectionSchemas.pruningCare();
    }
}
