...
@Component
public class WaterCareStrategy implements PlantBioSectionStrategy {

    @Override
    public PlantBioSectionKey key() {
        return PlantBioSectionKey.WATER_CARE;
    }

    @Override
    public String promptKey() {
        return "plant_water_care_v1";
    }
    ...
    public Map<String, Object> schema() {
        return BioSectionSchemas.waterCare();
    }
}
