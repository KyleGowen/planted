...
@Component
public class FertilizerCareStrategy implements PlantBioSectionStrategy {

    @Override
    public PlantBioSectionKey key() {
        return PlantBioSectionKey.FERTILIZER_CARE;
    }

    @Override
    public String promptKey() {
        return "plant_fertilizer_care_v1";
    }
    ...
    public Map<String, Object> schema() {
        return BioSectionSchemas.fertilizerCare();
    }
}
